...
<div class="grid">
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <div class="text-xs font-semibold">
            <span class="underline cursor-pointer text-blue-500 hover:decoration-blue-500" on:click|preventDefault={() => changeBatteryChargeTime()}>Force Charge:</span>
        </div>
        <div class="text-xs font-semibold">    
            {#if forceChargeEnabled}
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <!-- svelte-ignore a11y-no-static-element-interactions -->
        <div class="text-xs font-semibold">
            <div class="text-center text-xs font-semibold"><span class="underline cursor-pointer text-blue-500 hover:decoration-blue-500" on:click|preventDefault={() => changeSOC()}>Min SOC: </span></div> 
        </div>
        <div class="text-xs font-semibold">        
            {socValue}%
        </div>
...
{#if showSOCModal}
  <SOCModal bind:showSOCModal socValue={socValue} onConfirm={handleSOCChange}> 
    <h2 slot="header">
      <p class="mb-4 font-bold text-center dgs-red">Min SOC</p>
    </h2>
  </SOCModal>
{/if}
{#if showBatteryChargeModal}
  <BatteryChargeModal bind:showBatteryChargeModal forceChargeEnabled={forceChargeEnabled} st_hours={st_hours} st_minutes={st_minutes} et_hours={et_hours} et_minutes={et_minutes} onConfirm={handleBatteryChargeTimeChange}> 
    <h2 slot="header">
      <p class="mb-4 font-bold text-center dgs-red">Battery Charge Times</p>
    </h2>
  </BatteryChargeModal>
{/if}
